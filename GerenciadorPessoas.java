...
public class GerenciadorPessoas {
	...
	public String achaMaiorNomeRelacionadoIdade (Pessoa[] cadastraPessoas) {
		String maiorNomeRelacionadoIdade = "";
		
		for(Pessoa array : cadastraPessoas) {
			if(array.getIdade() == achaMaiorIdade(cadastraPessoas)) {
				maiorNomeRelacionadoIdade = array.getNome();
			}
		}
		System.out.println("O usuário mais velho cadastrado é: " + maiorNomeRelacionadoIdade + " e a idade dele é: " + achaMaiorIdade(cadastraPessoas) + " anos.");
		return maiorNomeRelacionadoIdade;
	}
	
	public String achaMenorNomeRelacionadoIdade (Pessoa[] cadastraPessoas) {
		String menorNomeRelacionadoIdade = "";
		
		for(Pessoa array : cadastraPessoas) {
			if(array.getIdade() == achaMenorIdade(cadastraPessoas)) {
				menorNomeRelacionadoIdade = array.getNome();
			}
		}
		System.out.println("O usuário mais novo cadastrado é: "+menorNomeRelacionadoIdade + " e a idade dele é: " + achaMenorIdade(cadastraPessoas) + " anos.");
		return menorNomeRelacionadoIdade;
	}
	...
	/*public Pessoa[] achaMaiorNomeIdade (Pessoa[] cadastraPessoas) {
		...
		Pessoa[] arrayAchaMaiorNomeIdade = new Pessoa[tamanho];
		for(int i = 0; i < cadastraPessoas.length; i++) {
			if(cadastraPessoas[i].getIdade() == achaMaiorIdade(cadastraPessoas)) {
		...
		System.out.println("Resultado Final: " + Arrays.toString(arrayAchaMaiorNomeIdade));
		return arrayAchaMaiorNomeIdade;
	}*/
}
